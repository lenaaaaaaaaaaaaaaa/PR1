package ru.mirea.nadezhkinaea.osmmaps;
...
import ru.mirea.nadezhkinaea.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setMarker(new GeoPoint(55.596470, 37.987620),
                "ДОМ", "Мой дом");

        setMarker(new GeoPoint(55.760257, 37.618536),
                "ТЕАТР", "Большой театр");

        setMarker(new GeoPoint(55.727782, 37.554060),
                "ПАРК", "Парк Новодевичьи Пруды");

        setMarker(new GeoPoint(55.771083, 37.620714),
                "РЕСТОРАН", "Found Record Store & Pizzeria");
    }
