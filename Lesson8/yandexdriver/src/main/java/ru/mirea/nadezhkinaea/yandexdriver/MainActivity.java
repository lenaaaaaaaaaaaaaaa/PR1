...
import ru.mirea.nadezhkinaea.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener,
        UserLocationObjectListener {
    private static final int REQUEST_CODE_PERMISSION = 100;
    private ActivityMainBinding binding;
    private final Point ROUTE_START_LOCATION = new Point(55.596470, 37.987620);
    private final Point ROUTE_END_LOCATION = new Point(54.187433, 45.183939);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isWork) {
            ...
            final Point userLoc = new Point(55.596470, 37.987620);
            submitRequest(userLoc);

            PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new
                            Point(54.187433, 45.183939),
                    ImageProvider.fromResource(this, R.drawable.i));
            ...
            marker.addTapListener(new MapObjectTapListener() {
                ...
                public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point point) {
                    Toast.makeText(MainActivity.this, "ЛЮБИМАЯ РЕСПУБЛИКА", Toast.LENGTH_SHORT).show();
                    return false;
                }
            });
        } else {
