package ru.mirea.nadezhkinaea.serviceapp;
...
public class PlayerService extends Service {
    ...
    public void onCreate() {
        ...
        NotificationCompat.Builder _builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setStyle(new NotificationCompat.BigTextStyle().bigText("Hippie Sabotage"))
                .setContentText("Wrong Time");
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            _channel = new NotificationChannel(CHANNEL_ID,
                    "Student Nadezhkina Lena Anatolyevna Notification", _importance);
        }
